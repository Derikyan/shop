...
export function Footer() {
  return (
    <footer className="w-full bg-cream mt-auto py-8 relative">
       ...
       {/* Bottom Decorative Illustrations */}
       <div className="flex justify-between items-end px-4 max-w-7xl mx-auto h-24 mb-4 relative opacity-80">
          <div className="flex items-end space-x-2">
            <div className="w-16 h-16 relative">
              <Image src="/tiles/azure-mosaic.svg" alt="" fill className="object-cover rounded-tl-[50%]" />
            </div>
            <div className="w-10 h-10 relative">
              <Image src="/tiles/terracotta-dot.svg" alt="" fill className="object-cover rounded-t-full" />
            </div>
             <div className="w-8 h-8 relative">
              <Image src="/tiles/yellow-star.svg" alt="" fill className="object-cover rounded-tr-full" />
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="flex flex-wrap justify-center items-center gap-4 text-xs font-bold font-display uppercase tracking-wider mb-2">
          ...
          <span className="hidden sm:inline">|</span>
          <a href="#" className="hover:text-terracotta transition-colors">Shipping Info</a>
          <span className="hidden sm:inline">|</span>
